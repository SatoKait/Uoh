...
namespace basecross {
	...
	void GameStage::CreatePollCollision()
	{
		...
		auto pollCollef = AddGameObject<PollCollision>(Vec3(18.0f, 4.0f, -35.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(12.0f, 4.0f, -35.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(15.0f, 2.2f, -35.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-18.0f, 4.0f, -35.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-12.0f, 4.0f, -35.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-15.0f, 2.2f, -35.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		
		pollCollef = AddGameObject<PollCollision>(Vec3(-27.8f, 4.0f, -20.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-32.2f, 4.0f, -20.0f), Vec3(0.5f, 8.0f, 0.75f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-30.0f, 2.3f, -20.0f), Vec3(2.5f, 4.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(27.8f, 4.0f, -20.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(32.3f, 4.0f, -20.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(30.0f, 2.3f, -20.0f), Vec3(2.5f, 4.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));

		pollCollef = AddGameObject<PollCollision>(Vec3(17.25f, 4.0f, 35.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(12.75f, 4.0f, 35.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(15.0f, 2.1f,  35.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(27.0f, 4.0f, 20.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(33.0f, 4.0f, 20.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(30.0f, 2.1f, 20.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));

		pollCollef = AddGameObject<PollCollision>(Vec3(-17.25f, 4.0f, 35.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-12.75f, 4.0f, 35.0f), Vec3(0.5f, 8.0f, 0.5f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-15.0f, 2.3f, 35.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-27.0f, 4.0f, 20.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-33.0f, 4.0f, 20.0f), Vec3(1.0f, 8.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
		pollCollef = AddGameObject<PollCollision>(Vec3(-30.0f, 2.3f, 20.0f), Vec3(3.5f, 4.0f, 1.0f), Vec3(0.0f, 0.0f, 0.0f));
