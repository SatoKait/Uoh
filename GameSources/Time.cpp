...
namespace basecross {
	...
	//Time::Time(const shared_ptr<Stage>& stagePtr, int number, Vec3 pos , wstring m_MeshResName) :
	//	GameObject(stagePtr),
	//	m_number(number),
	//	m_pos(pos),
	//	m_meshResName(m_MeshResName),
	//	m_width(40.0f),
	//	m_heigth(80.0f),
	//	m_color(Col4(0.1640f, 0.8632f, 0.2109f, 1.0f))
	//{}
	//Time::Time(const shared_ptr<Stage>& stagePtr, int number, wstring  m_MeshResName, Vec3 pos, float width,float heigth, Col4 color) :
	//	GameObject(stagePtr),
	//	m_number(number),
	//	m_pos(pos),
	//	m_meshResName(m_MeshResName),
	...
	//	m_color(color)
	//{}
	//Time::Time(const shared_ptr<Stage>& stagePtr, int number, Vec3 pos, float width, float heigth, wstring meshResName, Col4 color) :
	//	GameObject(stagePtr),
	//	m_number(number),
	//	m_pos(pos),
	//	m_width(width),
	...
	//	//{
	//	//	GetStage()->GetSharedGameObject<UIManager>(L"UIManager")->SetTimePtr(GetThis<Time>());//自分自身のポインタを渡す
	//	//}
	...
	//void Time::UpdateValue(int number) {
	...
	//void Time::ThisDestory() {
	//	GetStage()->RemoveGameObject<Time>(GetThis<Time>());

	//}
	////Col4 Time::GetColor() {
	////	return m_draw->GetDiffuse();
	////}
	////void Time::SetColor(Col4 color) {
